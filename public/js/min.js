...
$(document).ready(function () {
    $('.tt_tab_aff1').click(function(event) {
        $(".tt_tab_aff1").addClass('acc');
        $(".tab_aff1_body").addClass('acc');
     $(".tt_tab_aff2").removeClass("acc");
     $(".tt_tab_aff3").removeClass("acc");
     $(".tt_tab_aff4").removeClass("acc");
        $(".tab_aff2_body").removeClass("acc");
        $(".tab_aff3_body").removeClass("acc");
        $(".tab_aff4_body").removeClass("acc");
    });	
        
    $('.tt_tab_aff2').click(function(event) {
        $(".tt_tab_aff2").addClass('acc');
        $(".tab_aff2_body").addClass('acc');
        $(".tt_tab_aff1").removeClass("acc");
     $(".tt_tab_aff3").removeClass("acc");
     $(".tt_tab_aff4").removeClass("acc");
        $(".tab_aff1_body").removeClass("acc");
        $(".tab_aff3_body").removeClass("acc");
        $(".tab_aff4_body").removeClass("acc");
    });	
    
    $('.tt_tab_aff3').click(function(event) {
        $(".tt_tab_aff3").addClass('acc');
        $(".tab_aff3_body").addClass('acc');
        $(".tt_tab_aff2").removeClass("acc");
        $(".tt_tab_aff1").removeClass("acc");
        $(".tt_tab_aff4").removeClass("acc");
        $(".tab_aff2_body").removeClass("acc");
    ...
    $('.tt_tab_aff4').click(function(event) {
        $(".tt_tab_aff4").addClass('acc');
        $(".tab_aff4_body").addClass('acc');
         $(".tt_tab_aff2").removeClass("acc");
        $(".tt_tab_aff3").removeClass("acc");
        $(".tt_tab_aff1").removeClass("acc");
        $(".tt_tab_aff2").removeClass("acc");
    ...
    $("#changePassButton").on("click", function (e) {
           $(".fr_rb").addClass('active');	   
           $(".purple-circle-button").addClass("active");
    ...
    $(document).ready(function() {
                ...
                $(document).ready(function() {
                  $('.owl-carousel.slide_jp').owlCarousel({
                    loop: true,
                    loop:($(".slide_jp.owl-carousel .item").length > 3) ? true: false,
                    margin: 10,
                     nav: true,
                   responsiveClass: true,
                    autoplay:3000,
